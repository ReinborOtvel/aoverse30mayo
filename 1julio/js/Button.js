...
export default class Button {
  constructor(text, transform, clickCall) {
    ...
    this.size = (this.image.transform.height / 100) * 80;
    this.yWord = this.yInitial - ((this.image.transform.height - this.size) / 2);
  }
  update() {
    ...
    window.main.draw.word(this.text, xInitial, this.yWord, this.size);
  }
}