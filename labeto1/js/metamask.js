class Metamask {
    constructor(callback) {
        if (window.ethereum == undefined) {
            window.alert("Descargar metamask");
            return;
        }
        ...
        this.provedor.send("eth_requestAccounts", []).then(direcciones => {
            ...
            this.signer = this.provedor.getSigner();
    ...
    crearBaseDatos() {
        ...
        let creadorMayuscula = this.baseDatosInformacion.creador.toUpperCase();
        informacion.estadisticas[creadorMayuscula] = {
            nombre: "solitario",
            cabeza: 0,
            armadura: 0,
            arma: 0,
        ...
        informacion.grupo[creadorMayuscula] = [];
        informacion.lider[creadorMayuscula] = "0";
        informacion = JSON.stringify(informacion);
        let factory = new ethers.ContractFactory(
            this.baseDatosInformacion.abi,
            this.baseDatosInformacion.bytecode,
            this.signer
        );
        factory.deploy(informacion).then((contrato) => {
