...
export default function () {
  ...
  sketch.utils.image = (image, x, y, width, height) => {
    x = percentageSet(sketch.engine.width, x);
    y = percentageSet(sketch.engine.height, y);
    width = percentageSet(sketch.engine.width, width);
    height = percentageSet(sketch.engine.height, height);
